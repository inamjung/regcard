...
use app\modules\kpi\models\KpitypeSearch;
...
/**
 * KpitypeController implements the CRUD actions for Kpitype model.
 */
class KpitypeController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Kpitype",
                    'content'=>'<span class="text-success">Create Kpitype success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Kpitype model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Kpitype model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {
        if (($model = Kpitype::findOne($id)) !== null) {
            return $model;
        } else {
